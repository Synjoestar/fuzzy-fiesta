...
df = pd.read_csv("https://raw.githubusercontent.com/Synjoestar/fuzzy-fiesta/7601d97aa755d3d278cdfb29cbfa060d80542cf2/dashboard/cleaned_bikeshare_hour.csv")
...
with col1:
    st.markdown("[![LinkedIn](https://content.linkedin.com/content/dam/me/business/en-us/amp/brand-site/v2/bg/LI-Bug.svg.original.svg)](https://www.linkedin.com/in/surya-yusuf-nugroho/)")
with col2:
    st.markdown("[![Github](https://img.icons8.com/glyph-neue/64/FFFFFF/github.png)](https://github.com/Synjoestar)")
